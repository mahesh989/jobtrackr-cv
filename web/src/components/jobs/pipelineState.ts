...
export const PIPELINE_STATE_META: Record<PipelineState, PipelineStateMeta> = {
  ...
  below_final:     { label: "Below par",      tone: "warning", short: "Tailored CV scored below your final-ATS threshold (auto-skipped)", showAsBadge: true  },
  below_initial:   { label: "Low match",      tone: "warning", short: "Initial ATS scored below your starting threshold (auto-skipped)",  showAsBadge: true  },
