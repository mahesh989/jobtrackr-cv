...
const TERMS: Array<{ term: string; def: string }> = [
  ...
  { term: "Initial gate", def: "Your starting ATS threshold (default 55). Below it, a run can stop before tailoring to save AI cost." },
  { term: "Final gate", def: "Your post-tailoring ATS threshold (default 75)." },
