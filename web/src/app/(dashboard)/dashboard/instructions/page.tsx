 ...
 *
 *   Part 1  Get set up        — the SetupGuide stepped cards (with live ✓).
 *   Part 2  Key terms         — glossary of the app's vocabulary.
 *   Part 3  How it works      — discovery run, analysis flow, applying, tracking.
 *
 * Server-rendered. Reachable any time from the sidebar; also what new users
 * see on the dashboard until their first run produces data.
 */
...
const TERMS: Array<{ term: string; def: string }> = [
  ...
  { term: "Source", def: "Where jobs come from (SEEK, Adzuna, Careerjet, Greenhouse, Lever, Workday…). 21+ Australian sources." },
  ...
  { term: "Initial gate", def: "Starting ATS threshold (60). Below it, a run stops before tailoring to save AI cost." },
  { term: "Final gate", def: "Post-tailoring ATS threshold (70). At or above this, a cover letter is auto-generated." },
...
export default async function InstructionsPage() {
  ...
  return (
    <div className="min-h-full">
      ...
      <div className="px-6 py-6 space-y-10 max-w-3xl mx-auto">
        {/* Part 1 — Get set up */}
        ...
        <section className="anim-in space-y-6">
          ...
          <div className="bg-surface border border-border rounded-md p-4">
            ...
            <div className="max-w-xs mx-auto">
              ...
              <Arrow />
              <FlowBox tone="gate">Initial gate (≥ 55?) — below can stop here</FlowBox>
              <Arrow label="passes" />
              ...
              <Arrow />
              <FlowBox tone="gate">Final gate (≥ 75?)</FlowBox>
              <Arrow />
