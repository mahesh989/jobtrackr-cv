...
> design/decisions see `docs/design.md` (source of truth for "what"),
> `.claude/graph.json` (live state, "how far"), and `docs/CONTRACTS.md`
> (hand-authored invariants — the *why* behind rules that aren't obvious
> from reading the code). Regenerate rather than hand-edit when the repo
