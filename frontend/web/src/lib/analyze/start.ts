/**
 * Job-analysis orchestration — the full business logic behind
 * POST /api/jobs/[id]/analyze, extracted verbatim from the route
 * (2026-07-23 audit batch 5) so the route stays a thin auth/param shell.
 *
 * Flow: ownership chain → JD resolution (manual paste > fresh scrape >
 * stored description) → active-CV + structured-referee splice →
