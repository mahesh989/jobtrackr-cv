...
import type { ContactDetails, Project, ProfileCredentials, RoleFamily } from "./profile-settings/types";
import { ContactDetailsSection } from "./profile-settings/ContactDetailsSection";
import { RoleFamilyPicker } from "./profile-settings/RoleFamilyPicker";
import { TechLinksSection } from "./profile-settings/TechLinksSection";
import { PortfolioProjectsSection } from "./profile-settings/PortfolioProjectsSection";
import { HealthcareCredentialsSection } from "./profile-settings/HealthcareCredentialsSection";
import { ManualCredentialsSection } from "./profile-settings/ManualCredentialsSection";
import { AvailabilitySection } from "./profile-settings/AvailabilitySection";

export type { ContactDetails, Project, ProfileCredentials, RoleFamily } from "./profile-settings/types";
  ...
  return (
    <div className="space-y-6">
      ...
      {(showNursing || showManual) && (
        <AvailabilitySection creds={creds} setCred={setCred} toggleAvailability={toggleAvailability} />
      )}
