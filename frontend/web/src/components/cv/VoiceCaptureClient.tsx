...
import { CurrentProfileCard } from "./voice-capture/CurrentProfileCard";
import { SuccessResultCard } from "./voice-capture/SuccessResultCard";
import { CaptureForm } from "./voice-capture/CaptureForm";
import { WORD_MIN, countWords, type SourceTag, type SubmitResult, type VoiceProfile } from "./voice-capture/types";
