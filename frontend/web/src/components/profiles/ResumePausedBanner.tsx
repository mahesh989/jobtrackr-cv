  ...
  return (
    <div className="mb-4 rounded-md border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/10 px-4 py-3 flex items-center justify-between gap-3 flex-wrap">
      ...
      <button
        ...
        disabled={pending}
        className="gh-btn text-[12px] px-3 py-1.5 border-amber-300 dark:border-amber-700 text-amber-900 dark:text-amber-200 hover:bg-amber-100 dark:hover:bg-amber-900/20 shrink-0"
      >
