/**
 * /applications — the outbox (V2 redesign).
 *
 * 2 tabs:
...
import { StatusTabs, type ApplicationStatusCounts, type ApplicationStatusKey } from "@/features/applications/components/StatusTabs";
