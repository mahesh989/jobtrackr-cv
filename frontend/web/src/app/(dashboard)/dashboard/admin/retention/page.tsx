/**
 * /dashboard/admin/retention — User retention & engagement
 *
 * Answers:
                ...
                <tbody>
                  {atRiskUsers.map((u) => {
                    ...
                    return (
                      <tr key={u.id}>
                        <td>
                          <Link href={`/dashboard/admin/activity?user=${u.id}`} className="text-text font-medium hover:underline">
                            {u.email}
                          </Link>
                        </td>
                ...
                <tbody>
                  {topUsers.map((u) => {
                    ...
                    return (
                      <tr key={u.id}>
                        <td>
                          <Link href={`/dashboard/admin/activity?user=${u.id}`} className="text-text font-medium hover:underline">{u.email}</Link>
                        </td>
