  ...
  return (
    <main className="min-h-screen bg-bg text-text-2">
      ...
      <article className="max-w-2xl mx-auto px-6 py-12 space-y-8 text-lead leading-relaxed">
        <Link
          href="/"
          className="inline-flex items-center gap-1 text-label text-text-3 hover:text-text transition-colors"
        >
          ← Back to home
        </Link>
        <div>
          <h1 className="text-display font-medium text-text mb-3 tracking-tight">Terms of Service</h1>
          <p className="text-text-3">Effective: July 2026 · Applies to jobtrackr.app</p>
        </div>

        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">1. Acceptance of These Terms &amp; Who We Are</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">2. Eligibility</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">3. Accounts &amp; Security</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">4. Description of the Service</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">5. AI Features &amp; Accuracy</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">6. Bring-Your-Own-Key &amp; Third-Party AI Providers</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">7. Acceptable Use</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">8. Your Content &amp; Licence to Us</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">9. Intellectual Property</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">10. Plans, Billing, Renewals &amp; Cancellation</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">11. Australian Consumer Law</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">12. Disclaimers</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">13. Limitation of Liability</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">14. Indemnity</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">15. Suspension &amp; Termination</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">16. Changes to the Service &amp; These Terms</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">17. Governing Law &amp; Jurisdiction</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-h2 font-medium text-text">18. Contact</h2>
          <p>
