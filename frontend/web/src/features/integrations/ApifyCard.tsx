      ...
      <div>
        ...
        <div className="relative">
          <Input
            ...
            spellCheck={false}
          />
          <button type="button" onClick={onToggleShow} className="absolute right-2.5 top-1/2 -translate-y-1/2 text-text-3 hover:text-text-2 transition-colors" title={showToken ? "Hide" : "Show"} aria-label={showToken ? "Hide API token" : "Show API token"}>
            {showToken ? (
