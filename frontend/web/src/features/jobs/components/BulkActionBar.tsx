  ...
  return (
    <div className="sticky bottom-4 z-30 mx-auto max-w-2xl rounded-lg border border-[var(--border)] bg-surface shadow-lg px-4 py-2.5 flex items-center gap-3 flex-wrap">
      ...
      <div className="flex items-center gap-2 ml-auto flex-wrap">
        {progress ? (
          <>
            <span className="inline-flex items-center gap-1.5 text-label text-text-2">
          ...
          <>
            ...
            <button onClick={() => onSetConfirmAnalyse(false)} className="text-label text-text-3 hover:text-text px-2.5 py-1 transition-colors">
              Back
            </button>
          </>
        ) : (
          <>
            ...
            <button onClick={onStop} className="text-label text-text-3 hover:text-text px-2.5 py-1 transition-colors">
              Cancel
            </button>
          </>
        )}
