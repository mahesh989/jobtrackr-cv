// Careerjet AU adapter — v4 API listings (no Apify, no Cloudflare).
//
// HISTORY: this was rewritten to scrape careerjet.com.au/search HTML directly
// (commit 491fff4, May 2026) to capture fuller JDs. As of June 2026 that page
// serves a Cloudflare *Turnstile* challenge to Fly's datacenter IP (curl_cffi
